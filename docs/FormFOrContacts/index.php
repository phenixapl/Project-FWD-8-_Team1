          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
            <div class="box rounded">
              ...
              <p class="description">Ми будемо раді відповісти на ваші питання або
                 дати вам вказівки по телефону<br>
               <strong> <phone>+38 095 000 08 90</phone><br>
                <phone>+38 098 000 08 90</phone>
              </strong>
              </p>
            </div>
          </div>
          <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.6s">
            <div class="box rounded">
              ...
              <p class="description">Якщо ви хочете задати питання, просто напишіть нам по електронній пошті<br>
                <br>
                <email><strong>info@vilson.com.ua</strong></email>
              </p>
            </div>
          </div>
    ...
    <section id="maps"><!-- #map-->
      <div class="container wow fadeIn">
          <div class="section-header">
            <br>
            <br>
              <h3 class="section-title">Ми знаходимося тут</h3>
             
            </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.2s">
              <div class="map">
            <iframe  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10604.695878978382!2d24.403899371945904!3d48.35718065814222!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x953684a88822698a!2sVilson+hotel!5e0!3m2!1suk!2sua!4v1531905264807"    style="border:1px solid black; width: 100%;" allowfullscreen>
            </iframe>
          </div>
            </div>
          </div>
